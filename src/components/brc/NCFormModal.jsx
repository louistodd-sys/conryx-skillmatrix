      ...
      <div className="bg-card border border-border rounded-2xl w-full max-w-lg shadow-card-lg max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <Input className="mt-1" value={form.title} onChange={e => set('title', e.target.value)} placeholder="Brief description of NC" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div>
        ...
        <div className="flex justify-end gap-2 px-5 py-4 border-t border-border">
          ...
          <Button size="sm" onClick={handleSave} disabled={saving || !form.title || !form.raised_date}>
            {saving ? 'Saving…' : 'Save NC'}
          </Button>
        </div>
      </div>
    </div>
