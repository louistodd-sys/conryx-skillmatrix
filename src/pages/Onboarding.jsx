...
const PLAN_OPTIONS = [
  {
    ...
    label: 'Free',
    price: '£0',
    features: ['Track up to 10 employees', '10 skills', '3 categories', '1 admin login'],
    highlight: false,
  },
  {
    tier: 'essential',
    label: 'Essential',
    price: '£50',
    features: ['Track up to 50 employees', '30 skills', 'Unlimited categories', '2 admin logins + unlimited managers', 'Gap analysis & CSV export', 'Employee portal'],
    highlight: false,
  },
  {
    tier: 'professional',
    label: 'Professional',
    price: '£150',
    features: ['Track up to 500 employees', 'Unlimited skills', 'Unlimited admin logins', 'PDF reports', 'Advanced analytics', 'Site-level views'],
    highlight: true,
  },
];
