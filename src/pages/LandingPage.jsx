...
const PLANS_SKILLS = [
  ...
  },
  {
    ...
    features: ['Track up to 50 employees', '30 skills', 'Unlimited categories', 'Gap analysis & CSV export', '2 admin logins + managers'],
  ...
  },
  {
    ...
    features: ['Track up to 500 employees', 'Unlimited skills', 'Unlimited admin logins', 'PDF reports', 'BRC Compliance module included', 'Advanced analytics'],
    cta: 'Start free trial',
    highlight: true,
  },
]
